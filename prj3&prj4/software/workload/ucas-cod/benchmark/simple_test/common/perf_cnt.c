...
#define MEM_STORE_CYCLE  0x60012008
#define INST_FETCH_CYCLE 0x60013000
#define JUMP_CNT         0x60013008
#define PERF_CNT_08_ADDR 0x60014000
...
unsigned long _mem_store_cycle() {
  return *((volatile unsigned long *)MEM_STORE_CYCLE);
}
...
void bench_prepare(Result *res) {
  ...
  res->mem_store_cycle  = _mem_store_cycle() ;
...
void bench_done(Result *res) {
  ...
  res->mem_store_cycle  = _mem_store_cycle()  - res->mem_store_cycle ;
